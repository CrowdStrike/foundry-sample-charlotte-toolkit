  ...
  return (
    <div className="mitre-techniques-container space-y-3">
      {techniques.map((technique) => {
        const formattedDescriptions = formatMitreDescription(
          ...
          >
                ...
                <div className="flex items-center gap-1 mb-1">
                  ...
                  >
                    <SlButton
                      ...
                      onClick={() =>
                        copyMitreUrl(
                          buildMitreUrl(technique.technique_id),
            ...
            <div className="technique-description">
              {formattedDescriptions.length > 0 ? (
                formattedDescriptions.map((paragraph) => (
                  <p
                    key={`${technique.technique_id}-${paragraph.substring(0, 50)}`}
